...
echo ""
mysql --defaults-extra-file="mysql_${CLOUDSQL_ENV}.cnf"  < "create_${CLOUDSQL_ENV}_user.sql"
...
echo ""
mysql --defaults-extra-file="mysql_${CLOUDSQL_ENV}.cnf"  < "create_${CLOUDSQL_ENV}_database.sql"
