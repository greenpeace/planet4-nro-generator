...
echo ""
mysql --defaults-extra-file="mysql_${CLOUDSQL_ENV}.cnf"  < "delete_${CLOUDSQL_ENV}_user.sql"
...
echo ""
mysql --defaults-extra-file="mysql_${CLOUDSQL_ENV}.cnf"  < "delete_${CLOUDSQL_ENV}_database.sql"
echo "---------"
echo ""
